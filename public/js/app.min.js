...
$templateCache.put('admin/components/navbar/slap-navbar.html','<header class="slap-header"><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button> <a ui-sref="admin.home"><img src="./images/logo.png" alt="" class="logo-img"></a></div><div class="dropdown pull-right profile-dropdown visible-xs"><a class="dropdown-toggle text-white" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="images/carr-avatar.png" class="profile-image img-circle"> {{ $ctrl.user.name }} <i class="fa fa-chevron-down" aria-hidden="true"></i></a><ul class="dropdown-menu"><li><a ui-sref="payments">Payments</a></li><li role="separator" class="divider"></li><li><a ng-click="$ctrl.logout()">Logout</a></li></ul></div><ul class="nav navbar-nav navbar-right hidden-xs"><li><a href="#">Home</a></li><li class="dropdown"><a href="slapsters.index">SLAPsters</a></li><li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports<span class="caret"></span></a><ul class="dropdown-menu"><li><a ui-sref="report-builder.index">Report Builder</a></li></ul></li><li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Admin<span class="caret"></span></a><ul class="dropdown-menu"><li><a ui-sref="plans.list">Plans</a></li><li><a ui-sref="coupon.list">Promocode</a></li><li><a ui-sref="users.list">Users</a></li></ul></li><li class="dropdown pull-right profile-dropdown"><a class="dropdown-toggle text-white" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="images/carr-avatar.png" class="profile-image img-circle"> {{ $ctrl.user.name }} <i class="fa fa-chevron-down" aria-hidden="true"></i></a><ul class="dropdown-menu"><li role="separator" class="divider"></li><li><a ng-click="$ctrl.logout()">Logout</a></li></ul></li></ul></div></nav></header>');
...
$templateCache.put('admin/pages/main/index/main-index.html','<div class="container"><div class="row"><div class="col-md-offset-3 col-md-6"><h1>Home DashBoard</h1></div></div></div>');
...
$templateCache.put('admin/pages/manage_data/users/list/users-manage.html','<div class="container"><div class="row"><div class="col-md-12"><div class="panel panel-default"><div class="panel-body"><div class="text-right"><a class="btn btn-primary" ui-sref="plans.add"><i class="fa fa-plus"></i> Add</a></div><hr><table ng-table-dynamic="list with cols" class="table table-hover table-vertical-align ng-cloak"><tr ng-repeat="row in $data"><td ng-repeat="col in $columns" ng-switch="col.format" ng-class="col.style"><div ng-switch-when="raw" ng-bind-html="col.getValue(row)"></div><div ng-switch-when="compile" compile="col.getValue(row)"></div><div ng-switch-default="" ng-bind-html="col.getValue(row)"></div></td></tr><tr ng-if="!list.data.length"><td colspan="{{cols.length}}" class="text-center">You do not have records for display</td></tr></table></div></div></div></div></div>');
...
(function() {
    ...
    CouponItemController.$inject = ["$scope", "BCService", "productsService", "couponService", "toaster", "$stateParams", "$state"];
    angular
        .module('manage.coupon.module')
...
(function () {
    ...
    ProductsManageController.$inject = ["$scope", "$state", "BCService", "productsService", "NgTableParams"];
    angular
        .module('manage.products.module')
...
(function () {
    ...
    ProductsItemController.$inject = ["$scope", "BCService", "productsService", "toaster", "$state", "$stateParams"];
    angular
        .module('manage.products.module')
...
(function () {
    ...
    AdminUsersItemController.$inject = ["$scope", "pageService", "productsService", "toaster", "$state", "$stateParams"];
    angular
        .module('manage.users.module')
...
(function() {
    ...
    CouponManageController.$inject = ["$scope", "$state", "BCService", "couponService", "NgTableParams"];
    angular
        .module('manage.coupon.module')
...
(function () {
    ...
    AdminUsersManageController.$inject = ["$scope", "$state", "pageService", "productsService", "NgTableParams"];
    angular
        .module('manage.users.module')
...
(function () {
    ...
    productsService.$inject = ["adminApiService"];
    angular
        .module('app.services')
...
(function() {
    ...
    couponService.$inject = ["adminApiService"];
    angular
        .module('app.services')
