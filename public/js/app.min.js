...
$templateCache.put('admin/layouts/layout-default.html','<slap-navbar></slap-navbar><div class="container"><div class="row"><slap-breadcrumb></slap-breadcrumb></div></div><article ui-view="content"></article><slap-footer></slap-footer>');
...
$templateCache.put('admin/components/footer/slap-footer.html','<footer class="footer"><div class="container text-center"><hr><div class="col-lg-12"><div class="col-md-8"><p class="footertext pull-right">\xA9 2016. All rights reserved</p></div></div></div></footer>');
$templateCache.put('admin/components/navbar/slap-navbar.html','<header><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button> <a class="navbar-brand" href="#">SLAP Admin Panel</a></div><div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"><ul class="nav navbar-nav"><li><a href="#">Home</a></li><li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Manage data <span class="caret"></span></a><ul class="dropdown-menu"><li><a ui-sref="plans.list">Plans</a></li><li><a ui-sref="coupon.list">Promocode</a></li></ul></li><li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports<span class="caret"></span></a><ul class="dropdown-menu"><li><a ui-sref="financial_tracker.list">Financila tracker</a></li></ul></li></ul><ul class="nav navbar-nav navbar-right" ng-if="$ctrl.isAuthenticated"><li><a href="#">Hello <span ng-show="$ctrl.userService.user">{{ $ctrl.userService.user.name }}</span></a></li><li><a href="#" ng-click="$ctrl.logout()" ng-show="$ctrl.userService.user">Signout</a></li></ul><ul class="nav navbar-nav navbar-right" ng-if="!$ctrl.isAuthenticated"><li><a href="#"><span>Hello Guest</span></a></li></ul></div></div></nav></header>');
