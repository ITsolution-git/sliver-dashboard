...
(function () {
    ...
    MyaccountsController.$inject = ["$scope", "productStorage", "$state", "userService", "$auth"];
    angular
        .module('app.pages.settingsUser')
