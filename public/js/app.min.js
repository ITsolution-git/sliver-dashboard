...
$templateCache.put('admin/components/footer/slap-footer.html','<footer class="footer"><div class="container text-center"><hr><div class="col-lg-12"><div class="col-xs-12"><p class="footertext">SLAP ADMIN PORTAL.</p></div></div></div></footer>');
$templateCache.put('admin/components/navbar/slap-navbar.html','<header class="slap-header"><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button> <a ui-sref="admin.home"><img src="./images/logo.png" alt="" class="logo-img"></a></div><div class="dropdown pull-right profile-dropdown visible-xs"><a class="dropdown-toggle text-white" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="images/carr-avatar.png" class="profile-image img-circle"> {{ $ctrl.user.name }} <i class="fa fa-chevron-down" aria-hidden="true"></i></a><ul class="dropdown-menu"><li><a ui-sref="payments">Payments</a></li><li role="separator" class="divider"></li><li><a ng-click="$ctrl.logout()">Logout</a></li></ul></div><ul class="nav navbar-nav navbar-right hidden-xs"><li><a ui-sref="admin.home">Home</a></li><li class="dropdown"><a ui-sref="slapsters.list">SLAPsters</a></li><li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports<span class="caret"></span></a><ul class="dropdown-menu"><li><a ui-sref="report-builder.index">Report Builder</a></li></ul></li><li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Admin<span class="caret"></span></a><ul class="dropdown-menu"><li><a ui-sref="plans.list">Plans</a></li><li><a ui-sref="coupon.list">Promocode</a></li><li><a ui-sref="users.list">Users</a></li></ul></li><li class="dropdown pull-right profile-dropdown"><a class="dropdown-toggle text-white" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="images/carr-avatar.png" class="profile-image img-circle"> {{ $ctrl.user.name }} <i class="fa fa-chevron-down" aria-hidden="true"></i></a><ul class="dropdown-menu"><li role="separator" class="divider"></li><li><a ng-click="$ctrl.logout()">Logout</a></li></ul></li></ul></div></nav></header>');
...
$templateCache.put('pages/settingsUser/myaccounts/myaccounts.html','<div class="container-fluid m-t-es-30"><div class="row"><div class="col-md-12"><h1>My Accounts</h1><div class="panel panel-default">Reset Password</div><div class="panel panel-default">Email User name biz name Update</div><div class="panel panel-default">Account status</div><div class="panel panel-default p-es-10"><h3>Renew Account</h3><div><button class="btn btn-primary pull-right" ng-click="renewAccount()">Renew Account</button></div><div class="clearfix"></div></div></div></div></div>');
...
(function () {
    ...
    AdminSlapstersItemController.$inject = ["$scope", "$state", "pageService", "adminUserService", "NgTableParams", "$mdToast", "$q", "Restangular", "$mdDialog", "$timeout", "$rootScope", "commonDialogService", "$stateParams", "toaster", "buildData", "productData", "promocodeData", "activityData", "excuteItems", "actionplanService", "paymentsService"];
    angular
        .module('manage.users.module')
...
(function () {
    ...
    MyaccountsController.$inject = ["$scope", "pageService", "productStorage", "$state", "userService", "$auth"];
    angular
        .module('app.pages.settingsUser')
